...
$(function () {
    ...
    // it is second example of the up line of code 
    // $('p').on({
    //     click: () => { console.log('WOW CLICKED!'); },
    //     mouseleave: () => { console.log('BAD MOUSE LEFT!'); },
    //     mouseenter: () => { console.log('BEST MOUSE COME') },
    //     keypress: () => { console.log('YOU CLICKED BY KEYBOARD BTNS') }
    // });
